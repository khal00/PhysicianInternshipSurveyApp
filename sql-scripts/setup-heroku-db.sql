...
INSERT INTO `users` 
VALUES 
(1,'xi@m.com','{bcrypt}$2a$10$BSEX1pxjulNZcFCbsxb5mufJUhW1bQ8Yw5Tulyp7gjR1LhnkpWu8S',true),
(2,'min@m.com','{bcrypt}$2a$10$BSEX1pxjulNZcFCbsxb5mufJUhW1bQ8Yw5Tulyp7gjR1LhnkpWu8S',true),
(3,'ping@m.com','{bcrypt}$2a$10$BSEX1pxjulNZcFCbsxb5mufJUhW1bQ8Yw5Tulyp7gjR1LhnkpWu8S',true),
(4,'ho@m.com','{bcrypt}$2a$10$BSEX1pxjulNZcFCbsxb5mufJUhW1bQ8Yw5Tulyp7gjR1LhnkpWu8S',true),
(5,'chi@m.com','{bcrypt}$2a$10$BSEX1pxjulNZcFCbsxb5mufJUhW1bQ8Yw5Tulyp7gjR1LhnkpWu8S',true);

INSERT INTO `admin_personal_data`
VALUES
(1,'Ping','Po','123456789','Okręgowa Izba Lekarska w Szczecinie'),
(2,'Ho','Li','123456789','Okręgowa Izba Lekarska w Szczecinie'),
(3,'Chi','Fu','123456789','Okręgowa Izba Lekarska w Warszawie');
...
(1,'Samodzielny Publiczny Szpital Kliniczny Nr 1 w Szczecinie','Okręgowa Izba Lekarska w Szczecinie'),
(2,'SPSK Nr 2 w Szczecinie','Okręgowa Izba Lekarska w Szczecinie');
/*
(3,'ZOZ MSWIA w Warszawie','Okręgowa Izba Lekarska w Warszawie'),
(4,'111 Szpital Wojskowy w Poznaniu','Wielkopolska Izba Lekarska w Poznaniu');
*/
